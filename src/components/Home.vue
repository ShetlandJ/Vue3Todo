    ...
    <v-app>
        <v-content>
            <v-container>
                ...
                <div>
                    <p>The purpose of this repository is to demonstrate the code differences between Vue 2 and Vue 3. It was build for demonstrative purposes for the Vue Glasgow meetup.</p>
